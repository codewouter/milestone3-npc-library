...
# ---------- routes for NPCs ----------
# This route/function gets all NPC entries from the database and passes them to render the NPC overview list
@app.route('/get_npcs')
def get_npcs():
...
# This route/function gets all race and class entries from the db and passes them to render the newnpc page 
@app.route('/add_npc')
def add_npc():
...
# This route/function will read the form on the newnpc.html page and insert it as a new record in the dabase. 
...
# This route/function will recieve the relevant npc that needs to be viewed by the user and get the relevant data from the database.
# The data will then be passed to render the npcoverview.html page displaying all content about the specific NPC.
...
# This route/function will get all necessary values about the specific NPC that is selected,
# then pass all values to render the editnpc page so known values are prefilled in the edit form.
...
# This route/function will take all data from the form on the editnpc.html page and combined with the relevant id that is being passed from the page,
...
# This route/function will recive the selected npc_id and delete the entry from the database.
...
# ---------- routes for races ----------
# This route/function gets all race entries from the database and passes them to render race list
@app.route('/get_races')
def get_races():
...
# This route/function will read the form on the newrace.html page and insert it as a new record in the dabase
...
# This route/function will get all necessary values about the specific race that is selected,
# then pass all values to render the editrace page so known values are prefilled in the edit form.
...
# This route/function will take all data from the form on the editrace.html page and combined with the relevant id that is being passed from the page,
...
# This route/function will recive the selected race_id and delete the entry from the database.
...
# ---------- routes for classes ----------
# This route/function gets all class entries from the database and passes them to render race list
...
# This route/function will read the form on the newclass.html page and insert it as a new record in the dabase
...
# This route/function will get all necessary values about the specific class that is selected,
# then pass all values to render the editclass page so known values are prefilled in the edit form.
...
# This route/function will take all data from the form on the editclass.html page and combined with the relevant id that is being passed from the page,
#  then update the values in the database.
...
# This route/function will recive the selected class_id and delete the entry from the database.
